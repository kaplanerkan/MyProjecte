...
import com.erkankaplan.getlanipadressen.databinding.ItemBestSellerBinding
...
class BestSellersItemAdapter : RecyclerView.Adapter<BestSellersItemAdapter.BestSellersItemDesign>() {
    ...
    override fun onBindViewHolder(holder: BestSellersItemDesign, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            val selectedBook = bestSellersList[position]
            Log.e("BestSellersItemAdapter", "Selected Book: $selectedBook")
        }
    }
